...
public class PFFingerprintPinCodeHelper implements IPFPinCodeHelper {
     ...
     */
    @Override
    public void delete(Context context, PFPinCodeHelperCallback<Boolean> callback) {
        try {
     ...
     */
    @Override
    public void isPinCodeEncryptionKeyExist(Context context, PFPinCodeHelperCallback<Boolean> callback) {
        try {
